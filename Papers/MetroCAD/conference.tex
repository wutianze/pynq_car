...
Finally, the car can move by itself. It will be controlled by AI models or other algorithms.

\subsection{Simulator Use}



\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth,height=0.5\textheight]{simulator.png}}
...
\bibitem{33} TensorFlow [ONLINE] Available at: https://www.tensorflow.org
\end{thebibliography}
\vspace{12pt}
